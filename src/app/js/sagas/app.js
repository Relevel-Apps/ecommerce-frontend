...
import {
	...
	SET_CONFIRM_PAYMENT_SUCCESS, SET_CONFIRM_PAYMENT_ERROR_MSG, FETCH_VENDOR_PAYMENTS, SET_VENDOR_PAYMENTS, BACKEND_BASE_URL
} from './../constants/app';
...
function* userLogin(action) {
	...
	try {
		const responseBody = yield fetch( `${BACKEND_BASE_URL}/api/v1/user/login`, {
			method: 'POST',
			headers: {
...
function* userSignup(action) {
	...
	yield put({ type: SET_AUTH_ERROR_MSG, data: '' });
	try {
		const responseBody = yield fetch(`${BACKEND_BASE_URL}/api/v1/user/signup`, {
			method: 'POST',
			headers: {
				"Content-Type": "application/json;charset=UTF-8"
			},
...
function* fetchCategories(action) {
	const { data } = action;
	try {
		const responseBody = yield fetch(`${BACKEND_BASE_URL}/api/v1/category/all`, {
			method: 'POST',
			headers: {
				"Content-Type": "application/json;charset=UTF-8"
			},
...
function* fetchProducts(action) {
	const { data } = action;
	try {
		const responseBody = yield fetch(`${BACKEND_BASE_URL}/api/v1/product/all`, {
			method: 'POST',
			headers: {
				"Content-Type": "application/json;charset=UTF-8"
			},
...
function* fetchProductDetails(action) {
	const { data } = action;
	try {
		const responseBody = yield fetch(`${BACKEND_BASE_URL}/api/v1/product/details`, {
			method: 'POST',
			headers: {
				"Content-Type": "application/json;charset=UTF-8"
			},
...
function* fetchVendorDetails(action) {
	const { data } = action;
	try {
		const responseBody = yield fetch(`${BACKEND_BASE_URL}/api/v1/user/vendor/details`, {
			method: 'POST',
			headers: {
				"Content-Type": "application/json;charset=UTF-8"
			},
...
function* addProduct(action) {
	...
	try {
		const responseBody = yield fetch(`${BACKEND_BASE_URL}/api/v1/product/add`, {
			method: 'POST',
			headers: {
				"Content-Type": "application/json;charset=UTF-8"
			},
...
function* addToCart(action) {
	...
	try {
		const responseBody = yield fetch(`${BACKEND_BASE_URL}/api/v1/order/add`, {
			method: 'POST',
			headers: {
				"Content-Type": "application/json;charset=UTF-8"
			},
...
function* fetchOrderDetails(action) {
	const { data } = action;
	try {
		const responseBody = yield fetch(`${BACKEND_BASE_URL}/api/v1/order/details`, {
			method: 'POST',
			headers: {
				"Content-Type": "application/json;charset=UTF-8"
			},
...
function* editOrder(action) {
	...
	try {
		const responseBody = yield fetch(`${BACKEND_BASE_URL}/api/v1/order/edit`, {
			method: 'POST',
			headers: {
				"Content-Type": "application/json;charset=UTF-8"
			},
...
function* fetchVendorPayments(action) {
	const { data } = action;
	try {
		const responseBody = yield fetch(`${BACKEND_BASE_URL}/api/v1/user/vendor/payments`, {
			method: 'POST',
			headers: {
				"Content-Type": "application/json;charset=UTF-8"
			},
